        ...
        <section className={fontPoppins.className}>
           ...
           <section className="w-full">
              <div className="h-[112px] flex flex-col gap-[16px] text-center justify-center items-center mt-[64px] max-mt:h-[137px] max-st:h-[160px] max-sm:h-[195px]">
                <h1 className="w-[340px] h-[54px] font-semibold text-[32px] text-[#000000] max-mm:text-[26px] max-mm:h-[40px] max-sm:w-[280px]">Get In Touch With Us</h1>
                ...
                <div className="h-[537px] flex flex-col gap-[48px] justify-center">
                    ...
                    <div className="flex flex-row gap-8 items-center">
                      ...
                      <div className="flex flex-col gap-2">
                         <h2 className="w-[99px] h-[36px] font-medium text-[24px] text-[#000000] max-lt:text-[20px] max-lt:h-[30px]">Address</h2>
                    ...
                    <div className="flex flex-row gap-8 items-center">
                      ...
                      <div className="flex flex-col gap-2">
                         <h2 className="w-[76px] h-[36px] font-medium text-[24px] text-[#000000] max-lt:text-[20px] max-lt:h-[30px]">Phone</h2>
                    ...
                    <div className="flex flex-row gap-8 items-center">
                      ...
                      <div className="flex flex-col gap-2">
                         <h2 className="w-[166px] h-[36px] font-medium text-[24px] text-[#000000] max-lt:text-[20px] max-lt:h-[30px]">Working Time</h2>
                ...
                <div className="h-[923px]">
                    <div className="h-[741px] flex flex-col gap-[24px] max-mt:items-center">
                        <div className="h-[121px] flex flex-col gap-[8px] justify-between max-lt:justify-evenly">
                          <p className="w-[111px] h-[24px] font-semibold text-[16px] text-[#000000] max-lt:font-medium">Address</p>
                        ...
                        <div className="h-[121px] flex flex-col gap-[8px] justify-between max-lt:justify-evenly">
                          <p className="w-[143px] h-[24px] font-semibold text-[16px] text-[#000000] max-lt:font-medium">Email address</p>
                        ...
                        <div className="h-[121px] flex flex-col gap-[8px] justify-between max-lt:justify-evenly">
                          <p className="w-[75px] h-[24px] font-semibold text-[16px] text-[#000000] max-lt:font-medium">Subject</p>
                        ...
                        <div className="h-[155px] flex flex-col gap-[8px] justify-between max-lt:justify-evenly">
                          <p className="w-[76px] h-[24px] font-semibold text-[16px] text-[#000000] max-lt:font-medium">Message</p>
                        ...
                        <div className="w-[320px] mt-[32px] ml-[24px] max-sm:w-[280px] max-sm:ml-[12px]">
                          <div className="w-[265px] h-[64px] border-2 border-[#B88E2F] bg-[#B88E2F] flex items-center justify-center cursor-pointer max-lt:w-[200px] max-lt:h-[55px] max-lm:w-[150px] max-lm:h-[50px]">
