...
let BlogSection = () => {
    return(
        <section className={fontPoppins.className}>
                   ...
                   <div className="h-[885px] flex flex-col gap-[32px] max-xl:h-[775px] max-lt:gap-[26px] max-lt:h-[750px] max-mt:h-[725px] max-st:items-center max-sm:h-[775px]">
                      ...
                      <div className="h-[24px] flex flex-row gap-[16px]">
                          <div className="flex flex-row gap-[8px] items-center">
                             ...
                             <p className="w-[53px] h-[24px] font-normal text-[16px] text-[#9F9F9F] max-lt:text-[14px] max-lt:w-[50px] max-lt:h-[20px]">Admin</p>  
                           </div>
                           <div className="flex flex-row gap-[8px] items-center">
                             <img className="w-[20px] h-[20px] max-lt:w-[16px] max-lt:h-[16px]" src="/blogimg/icontwo.png" alt="icontwo" />  
                             <p className="w-[96px] h-[24px] font-normal text-[16px] text-[#9F9F9F] max-lt:text-[14px] max-lt:w-[80px] max-lt:h-[20px]">14 Oct 2022</p>  
                           </div>
                           <div className="flex flex-row gap-[8px] items-center">
                             <img className="w-[20px] h-[20px] max-lt:w-[16px] max-lt:h-[16px]" src="/blogimg/iconone.png" alt="iconone" />  
                             <p className="w-[47px] h-[24px] font-normal text-[16px] text-[#9F9F9F] max-lt:text-[14px] max-lt:w-[42px] max-lt:h-[20px]">Wood</p>  
                           </div>
                       </div>
                       <h1 className="h-[45px] font-medium text-[30px] text-[#000000] max-lg:text-[26px] max-lg:h-[40px] max-lt:text-[22px] max-lt:h-[35px] max-mt:text-[18px] max-mt:h-[30px] max-sm:text-[16px]">Going all-in with millennial design</h1>
               ...
               <div className="flex flex-col gap-[48px] max-st:items-center">
                  <div className="w-[360px] h-[537px] flex flex-col gap-[16px] items-center max-lg:w-[320px] max-lt:w-[275px] max-mt:w-[250px] max-st:h-[453px]">
                    ...
                    <div className="w-[320px] h-[353px] flex flex-col gap-[32px] mt-[32px] max-lg:w-[300px] max-lt:w-[250px] max-mt:w-[225px]">
                        ...
                        <div className="w-[300px] h-[28px] flex flex-row justify-between max-lg:w-[280px] max-lt:w-[250px1] max-mt:w-[225px]">
                  ...
                  <div className="w-[360px] h-[650px] flex flex-col gap-[32px] max-lg:w-[320px] max-lt:w-[275px] max-mt:w-[250px] max-st:h-[548px]">
                    ...
                    <div className="flex flex-row gap-4 items-center rounded-[12px]">
                      <img className="w-[80px] h-[80px] rounded-[12px] max-lg:w-[70px] max-lg:h-[70px]" src="/blogimg/smimgone.jpg" alt="iconthree" />
                    ...
                    <div className="flex flex-row gap-4 items-center rounded-[12px]">
                      <img className="w-[80px] h-[80px] rounded-[12px] max-lg:w-[70px] max-lg:h-[70px]" src="/blogimg/smimgtwo.jpg" alt="iconthree" />
                      <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-row gap-4 items-center rounded-[12px]">
                      <img className="w-[80px] h-[80px] rounded-[12px] max-lg:w-[70px] max-lg:h-[70px]" src="/blogimg/smimgthree.jpg" alt="iconthree" />
                      <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-row gap-4 items-center rounded-[12px]">
                      <img className="w-[80px] h-[80px] rounded-[12px] max-lg:w-[70px] max-lg:h-[70px]" src="/blogimg/smimgfour.jpg" alt="iconfour" />
                      <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-row gap-4 items-center rounded-[12px]">
                      <img className="w-[80px] h-[80px] rounded-[12px] max-lg:w-[70px] max-lg:h-[70px]" src="/blogimg/smimgfive.jpg" alt="iconfive" />
                      <div className="flex flex-col gap-2">
          ...
          <div className="w-[60px] h-[60px] max-st:w-[50px] max-st:h-[50px] max-sm:w-[40px] max-sm:h-[40px] flex flex-col items-center justify-center bg-[#B88E2F]">
            <p className="w-[7px] h-[30px] text-[#FFFF]">1</p>
          </div>
          <div className="w-[60px] h-[60px] max-st:w-[50px] max-st:h-[50px] max-sm:w-[40px] max-sm:h-[40px] flex flex-col items-center justify-center bg-[#F9F1E7]">
            <p className="w-[7px] h-[30px] font-semibold text-[#000000]">2</p>
          </div>
          <div className="w-[60px] h-[60px] max-st:w-[50px] max-st:h-[50px] max-sm:w-[40px] max-sm:h-[40px] flex flex-col items-center justify-center bg-[#F9F1E7]">
            <p className="w-[7px] h-[30px] text-[#000000]">3</p>
          </div>
          <div className="w-[98px] h-[60px] max-st:h-[50px] max-st:w-[75px] max-sm:h-[40px] flex flex-col items-center justify-center bg-[#F9F1E7]">
